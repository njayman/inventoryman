...
CREATE TABLE `__new_customers` (
	...
	`email` text NOT NULL,
	`phone` text,
	`created_at` integer DEFAULT '"2025-08-16T14:46:13.025Z"',
	`updated_at` integer DEFAULT '"2025-08-16T14:46:13.025Z"'
);
...
CREATE TABLE `__new_restocks` (
	...
	`unit` text NOT NULL,
	`price` real NOT NULL,
	`restocked_at` integer DEFAULT '"2025-08-16T14:46:13.025Z"',
...
CREATE TABLE `__new_sales` (
	...
	`sale_date` integer DEFAULT '"2025-08-16T14:46:13.025Z"',
...
CREATE TABLE `__new_suppliers` (
	...
	`email` text NOT NULL,
	`phone` text,
	`created_at` integer DEFAULT '"2025-08-16T14:46:13.024Z"',
	`updated_at` integer DEFAULT '"2025-08-16T14:46:13.024Z"'
);
--> statement-breakpoint
