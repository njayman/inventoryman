...
CREATE TABLE `__new_customers` (
	...
	`email` text NOT NULL,
	`phone` text,
	`created_at` integer DEFAULT '"2025-08-16T14:37:06.728Z"',
	`updated_at` integer DEFAULT '"2025-08-16T14:37:06.728Z"'
);
...
CREATE TABLE `__new_products` (
	...
	`created_at` integer DEFAULT '"2025-08-16T14:37:06.729Z"',
	`updated_at` integer DEFAULT '"2025-08-16T14:37:06.729Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_restocks` (
	...
	`unit` text NOT NULL,
	`price` real NOT NULL,
	`restocked_at` integer DEFAULT '"2025-08-16T14:37:06.729Z"',
...
CREATE TABLE `__new_sales` (
	...
	`sale_date` integer DEFAULT '"2025-08-16T14:37:06.729Z"',
